   ...
   <div class="bg-white mt-10">
     <!-- Title -->
      ...
      <section class="text-center py-12 px-6">
        ...
        <!-- Testimonials -->
        <div class="py-16 px-6" id="testimonials">
          <div class="max-w-6xl mx-auto">
            ...
            <div class="grid gap-6 md:grid-cols-2">
              ...
              <div class="bg-gray-700 p-6 rounded shadow">
                <p class="text-gray-100 italic">“Love the salt vs. chlorine breakdown they gave us. They’re not just a service—they’re a pool partner.”</p>
                <p class="mt-2 font-semibold text-gray-300">— Marcus L., The Woodlands TX</p>
              </div>
            </div>
          </div>
        </div> 
